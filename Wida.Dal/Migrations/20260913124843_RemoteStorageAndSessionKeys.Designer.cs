...
namespace Wida.Dal.Migrations
{
    ...
    [Migration("20260913124843_RemoteStorageAndSessionKeys")]
    partial class RemoteStorageAndSessionKeys
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wida.Dal.Entities.AppUser", b =>
                {
                    ...
                    b.Property<int>("AnalysisPagesGranted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(4);

                    b.Property<int>("AnalysisPagesUsed")
                        .HasColumnType("integer");
